#!/usr/bin/env python3
"""
DISABLED: Local LM training is not used. The system uses Hugging Face DistilGPT-2.
"""

raise ImportError("train_conversational_lm_windows.py is disabled. Use DistilGPT-2 via transformers.")
