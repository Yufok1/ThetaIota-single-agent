#!/usr/bin/env python3
"""
DISABLED: Local tiny LM training is not used. The system uses Hugging Face DistilGPT-2.
"""

raise ImportError("train_tiny_lm.py is disabled. Use DistilGPT-2 via transformers.")
